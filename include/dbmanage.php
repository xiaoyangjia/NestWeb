 ...
 * @link  http://www.yanue.net/archives/174.html
 * @version 1.1
 * 创建时间： 2012年5月21日
...
class DbManage {
	...
	function __construct($host = 'localhost', $username = 'root', $password = '', $thisatabase = 'test', $charset = 'utf8') {
		...
		*/
		$this->host = $GLOBALS['cfg_db_host'];
		$this->username = $GLOBALS['cfg_db_username'];
		$this->password = $GLOBALS['cfg_db_password'];
		$this->database = $GLOBALS['cfg_db_dbname'];
		$this->charset = 'utf8';
	...
	private function _retrieve() {
		...
		$value .= '-- http://www.yanue.net ' . $this->ds;
		$value .= '--' . $this->ds;
